...
//Define VGA TEXT BUFFER SIZE(25 rows, 80 colums)
...
//VGA BUFFER TESTS
#[test_case]
fn test_vga_buffer_println(){
    println!("simple println test output");
}

#[test_case]
fn test_vga_buffer_many(){
    for i in 0..200{
        println!("printing line number {}", i+1);
    }
}
